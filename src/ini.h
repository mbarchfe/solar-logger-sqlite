...
extern int InitAnzahl(char *Text, int MAX);
extern void InitOutputType(int Anzahl, int *Type, char *Text);
extern void InitOutputFormat(int Anzahl, int *Format, char *Text);
