...
// Globale Variable
extern int		AnzahlSollWR;						// Anzahl der WR laut INI Datei
extern int		AnzahlErfassterWR;					// Anzahl der erfassten WR (um ein erfassen der WR zu erzwingen auf 0 setzen)
extern DWORD	WRHandles[DEVMAX];					// Handles der WR



extern void WRInit(void);
extern void WRErfassen(void);
extern void WRErfassenWiederholen(void);
