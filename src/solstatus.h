...
*
***************************************************************************
*  DateiName:	solstatus.h
*  Status:		InArbeit
***************************************************************************/



extern void StatusINI(void);
extern void StatusUebersichtGesamt(void);
extern void StatusUebersicht(void);
extern void StatusDatei(DWORD SN, char *Type, char *Name, char *WertText);
extern void Status(DWORD KanalHandle, DWORD WRHandle, char *WertText);
extern void StatusMail(void);
