...
#include <sys/types.h>
#include <sys/stat.h>
#include <signal.h>					// für Signalhandler
#include <fcntl.h>					// für Dateisperren ???



extern void start_daemon (const char *log_name, int facility);
extern void stop_daemon (void);
extern int theonly_daemon(void);
