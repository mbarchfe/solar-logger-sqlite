...
*
***************************************************************************
*  DateiName:	wrabfragen.h
*  Status:		InArbeit
***************************************************************************/



extern void		WRKanaeleINI(void);
extern int 		KanalWertZeichenAnzahlMAX(DWORD KanalHandle);
extern double 	KanalAbfragen(DWORD KanalHandle, DWORD WRHandle, char *WertText, int Zeichen);
extern double 	KanalAbfragenSN(DWORD KanalHandle, char *SN, char *WertText, int Zeichen);
extern int 		KanalAbfragenMoeglich(void);
